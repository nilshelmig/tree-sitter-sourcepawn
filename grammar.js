...
module.exports = grammar({
  ...
  rules: {
    ...
    declaration_list: ($) => seq("{", repeat($._top_level_item), "}"),
    ...
    compound_statement: ($) => seq("{", repeat($._top_level_item), "}"),
    ...
    parameter_list: ($) =>
      seq("(", commaSep(choice($.parameter_declaration, "...")), ")"),
    ...
    concatenated_string: ($) =>
      seq($.string_literal, repeat1($.string_literal)),
